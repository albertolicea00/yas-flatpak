# 📦 Yet Another Store for Flatpak

> A modern, premium GUI wrapper for the **Flatpak** (`flatpak`) package manager.
...
**Yet Another Store for Flatpak** brings all that CLI power into a stunning, native-feeling graphical user interface. No more forgotten commands, no more syntax errors. Just pure, visual package management.
...
- **Official Website/Repository**: [Flatpak](https://flatpak.org)

## 🛠️ Requirements

- The `flatpak` command-line tool must be installed on your system and available in your shell's `PATH`.
...
```bash
git clone https://github.com/albertolicea00/yas-flatpak.git
cd yas-flatpak
cmake --preset default        # configure (Ninja, Debug)
cmake --build --preset default
./build/default/yas-flatpak
```
...
- 🐛 [Report a bug](https://github.com/albertolicea00/yas-flatpak/issues/new?template=bug_report.md)
- 💡 [Request a feature](https://github.com/albertolicea00/yas-flatpak/issues/new?template=feature_request.md)

## ⚖️ License & Legal

**Yet Another Store for Flatpak** is released under the **[MIT License](LICENSE)**.
...
Third-party tools (primarily **Flatpak**) are not bundled and governed by their own licenses.
